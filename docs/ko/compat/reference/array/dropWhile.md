...
대신 더 빠르고 현대적인 `es-toolkit`의 [dropWhile](../../../reference/array/dropWhile.md)을 사용하세요.
...
- `predicate?` (`ListIteratee<T>`): 각 요소에 적용할 조건 함수예요. 함수, 객체 패턴, 배열 패턴, 또는 속성 이름을 받을 수 있어요. 기본값은 `identity`예요.
