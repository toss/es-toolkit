...
- `doesMatch` (`((item: T, index: number, collection: any) => unknown) | Partial<T> | [keyof T, unknown] | PropertyKey`, optional): The search condition. Can use a function, partial object, property-value pair, or property name. Default is the `identity` function.
