...
- It has been adopted by popular open-source projects including MUI(Material UI, Base UI, MUI X), Storybook, Recharts, and CKEditor, and is recommended by Nuxt.
