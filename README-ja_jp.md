...
- es-toolkitは、[Storybook](https://github.com/storybookjs/storybook/blob/9d862798d666678cc4822e857c00bbd744169ced/code/core/package.json#L358)、[Recharts](https://github.com/recharts/recharts/blob/0fa4cc325da403b6fa1c6be0f820896ed92f806a/package.json#L94)、[ink](https://github.com/vadimdemedes/ink/blob/2090ad9779be59dea71d173eb49785b7bd4495d0/package.json#L55)、[CKEditor](https://github.com/ckeditor/ckeditor5/blob/60d5fac804643cb4d359767ee2f94e3d92d1fcc5/packages/ckeditor5-core/package.json#L53)など、信頼性の高い人気のオープンソースプロジェクトで利用されています。
...
es-toolkitは、Claude Code、Cursor、Copilotなど、AIコーディングツールで使える[Agent Skills](https://skills.sh)を提供しています。

```bash
npx skills add toss/es-toolkit
```

Claude Codeをご利用の場合は、プラグインマーケットプレイスからもインストールできます:
