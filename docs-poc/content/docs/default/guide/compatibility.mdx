---
title: Lodash Compatibility
description: Compatibility with Lodash using es-toolkit/compat
---

Starting with version 1.39.3, we ensure 100% compatibility with Lodash.
...
- Feature differences identified while migrating code from lodash to es-toolkit.
