...
describe('chunk', () => {
  it(
    "(non-curried) should return an empty array when the input array is empty",
    () => {
  ...
  it(
    "(non-curried) should throw if the size is not an integer of is less than 1",
    () => {
  ...
  it("(curried) should throw if the size is not an integer of is less than 1", () => {
    expect(() => chunk(0)([1, 2, 3])).toThrowErrorMatchingInlineSnapshot(
      `[Error: Size must be an integer greater than zero.]`
    );
    expect(() => chunk(-1)([1, 2, 3])).toThrowErrorMatchingInlineSnapshot(
      `[Error: Size must be an integer greater than zero.]`
    );
    expect(() => chunk(0.5)([1, 2, 3])).toThrowErrorMatchingInlineSnapshot(
      `[Error: Size must be an integer greater than zero.]`
    );
    expect(() => chunk(Math.PI)([1, 2, 3])).toThrowErrorMatchingInlineSnapshot(
      `[Error: Size must be an integer greater than zero.]`
    );
  });

  it(
    "(non-curried) should evenly divide all elements into chunks of the specified size when the total length is a multiple of the size",
    () => {
  ...
  it(
    "(non-curried) should place the remaining elements in the last chunk when the total length is not a multiple of the size",
    () => {
  ...
  it("(curried) should place the remaining elements in the last chunk when the total length is not a multiple of the size", () => {
    expect(chunk(6)([1, 2, 3, 4])).toEqual([[1, 2, 3, 4]]);
    expect(chunk(2)([1, 2, 3, 4, 5, 6, 7])).toEqual([[1, 2], [3, 4], [5, 6], [7]]);
  });
});
