...
import { type MergeDeep } from './merge.ts';
 ...
 * @returns {MergeDeep<T, S>} A new object with properties from the source object merged into a deep clone of the target object.
 *
